...
export const Amount = ({ setStep, onSubmit }: Props) => {
  ...
  return (
    <>
      ...
      <p className="text-center text-white-muted text-lg mb-4">Choose the amount of satoshis to send.</p>
        ...
        <div className="flex-1">
          ...
          <Input
            {...register("platformSatsAmount", {
              min: { value: 1, message: "Leave empty or minimum amount is 1 sat" },
              valueAsNumber: true,
            })}
            type="number"
          ...
          <p className="text-xs">Helps cover server costs and motivates further development. Thank you!</p>
        </div>
      </div>
      ...
      <div className="flex gap-2">
        <Button className="group flex-1 items-center" variant="secondary" onClick={() => setStep((step) => step - 1)}>
        ...
        <Button type="button" className="group flex-3 items-center" onClick={() => handleSubmit(onSubmit)()}>
          <span>Continue</span>
